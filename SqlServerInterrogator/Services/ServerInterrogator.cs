        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        while (await reader.ReadAsync(cancellationToken))
        {
            yield return new DatabaseInfo
            {
                ...
                CollationName = reader.IsDBNull(reader.GetOrdinal("CollationName")) ? null : reader.GetString(reader.GetOrdinal("CollationName")),
                RecoveryModel = reader.IsDBNull(reader.GetOrdinal("RecoveryModel")) ? null : reader.GetString(reader.GetOrdinal("RecoveryModel")),
                ...
                DefaultFileGroup = reader.IsDBNull(reader.GetOrdinal("DefaultFileGroup")) ? null : reader.GetString(reader.GetOrdinal("DefaultFileGroup")),
                ...
                UserAccess = reader.IsDBNull(reader.GetOrdinal("UserAccess")) ? null : reader.GetString(reader.GetOrdinal("UserAccess"))
            };
        }
    }
}
